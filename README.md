...
[cite_start]This repository contains the official implementation of the paper **"PWD: Prior-Guided and Wavelet-Enhanced Diffusion Model for Fast Limited-Angle imaging on Dental CT"**[cite: 1, 8].
